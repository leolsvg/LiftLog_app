        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Text("Rejoins la communauté LiftLog", style: TextStyle(color: Colors.grey[400], fontSize: 16)),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () async {
                    final user = await _auth.signUp(_emailController.text, _passController.text);
              ...
              Center(
                child: TextButton(
                  ...
                  child: RichText(
                    text: TextSpan(text: "Déjà un compte ? ", style: const TextStyle(color: Colors.grey), children: [
                      TextSpan(text: "Se connecter", style: TextStyle(color: accentCyan, fontWeight: FontWeight.bold)),
                    ]),
                  ),
                ),
              ),
